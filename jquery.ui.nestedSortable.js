 ...
 */
 /*  
  * Edited for use in PLister by Tim Pittman
  */
...
//			else if (previousItem != null && previousItem[0].children[1] != null) {
...
//			}
//			else {
				this._isAllowed(parentItem, level+childLevels+1);
//			}
		...
		_mouseStop: function(event, noPropagation) {
			//console.warn(this.beyondMaxLevels);
		...
		_isAllowed: function(parentItem, levels) {
			...
			if (parentItem != null) {
				if (parentItem.hasClass(o.disableNesting) || !o.isAllowed(this.currentItem, parentItem)) {
					//console.debug(parentItem.children(".row").attr('class'));
					this.placeholder.addClass(o.errorClass);
					this.beyondMaxLevels = (o.maxLevels - levels) > 0 ? o.maxLevels - levels : 1;
				} else {
